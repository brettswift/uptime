 ...
 * @api   public
 */
function HttpPoller(check, timeout, callback) {
  HttpPoller.super_.call(this, check, timeout, callback);
...
HttpPoller.prototype.onResponseCallback = function(res) {
  ...
  if (statusCode == 200) {
    ...
    res.on('end', function() {
      ...
      contentParser.getXmlValue(body, poller.check.jsonPath, function(err, version){
        var version = version;
